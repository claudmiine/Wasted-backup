    ...
    <v-card class="mx-auto" max-width="344">
      ...
      <v-expand-transition>
        <div v-show="show">
          ...
          <v-card-text>
            Recycling is an important practice that has gained significant attention in recent years. It involves the
    ...
    <v-card class="mx-auto" max-width="344">
      ...
      <v-expand-transition>
        <div v-show="show">
          ...
          <v-card-text>
            Plastic bags are ubiquitous in our daily lives. They are cheap, convenient, and readily available. However,
            ...
            In addition to harming wildlife and ecosystems, plastic bags can also have negative impacts on human health.
            Toxic chemicals from plastic bags can leach into soil and water, potentially contaminating food sources and
            drinking water. Plastic bags can also contribute to air pollution, as they release harmful greenhouse gases
            when they are produced and disposed of.

            To address the environmental impact of plastic bags, many governments and organizations have implemented
            policies and programs to reduce their use. Some countries have banned or taxed single-use plastic bags, while
            others have encouraged the use of reusable bags or implemented recycling programs.
